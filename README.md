...
```bash
git clone https://github.com/RomainDussuchal/xora-saas-landing.git
...
> **IMPORTANT 👇**: The file should be named `index.jsx`, not `index.js`. This change is necessary because we've added SVG components in the constants file.
...
**I followed the "Advance your skills with Next.js 14 Pro Course" which allow me to be fully independent creating this 
kind of content **
